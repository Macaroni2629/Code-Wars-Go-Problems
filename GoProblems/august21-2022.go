// https://www.codewars.com/kata/56b97b776ffcea598a0006f2/train/go
...
// 7, 5, 3, 1, 2, 4, 6, 8, 9
// []int{7, 5, 3, 1, 2, 4, 6, 8, 9} // The "9" and "7" have been swapped because 9 is larger than 7 and thus 9 should be after 7
